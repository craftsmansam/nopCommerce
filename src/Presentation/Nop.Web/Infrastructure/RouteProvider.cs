...
public partial class RouteProvider : BaseRouteProvider, IRouteProvider
{
    ...
    public void RegisterRoutes(IEndpointRouteBuilder endpointRouteBuilder)
    {
     ...
     new { controller = "Quote", action = "QuoteDetails" });
        ...
        endpointRouteBuilder.MapControllerRoute("SpiralCalculator", $"{lang}/calculators/spiral-calculator",
            new { controller = "Calculators", action = "SpiralCalculator" });

        //Albina tangent materials
        endpointRouteBuilder.MapControllerRoute("TangentMaterials", $"{lang}/calculators/tangent-materials",
            new { controller = "Calculators", action = "TangentMaterials" });

        //Albina bending tolerences
        endpointRouteBuilder.MapControllerRoute("BendingTolerances", $"{lang}/calculators/bending-tolerances",
            new { controller = "Calculators", action = "BendingTolerances" });

        endpointRouteBuilder.MapControllerRoute("AlbinaInvoiceList", $"{lang}/secure/invoice-list",
        ...
        endpointRouteBuilder.MapControllerRoute("BrowsePictureVault", $"{lang}/secure/browse-picture-vault",
            new { controller = "PictureVault", action = "BrowsePictureVault" });

        //Albina Picture Vault
        endpointRouteBuilder.MapControllerRoute("PictureVault", $"{lang}/secure/picture-vault",
            new { controller = "PictureVault", action = "PictureVault" });

        //Albina Picture Vault
        endpointRouteBuilder.MapControllerRoute("ShowPicture", $"{lang}/secure/show-picture",
            new { controller = "PictureVault", action = "ShowPicture" });

        endpointRouteBuilder.MapControllerRoute("ShowVideo", $"{lang}/secure/show-video",
            new { controller = "PictureVault", action = "ShowVideo" });

        endpointRouteBuilder.MapControllerRoute("ShowVideo", $"{lang}/secure/video-player",
            new { controller = "PictureVault", action = "VideoPlayer" });

        //Albina Bending and Fabrication
        endpointRouteBuilder.MapControllerRoute("BendingAndFabrication", $"{lang}/quote-request/bending-and-fabrication",
        ...
        endpointRouteBuilder.MapControllerRoute("BendingAndFabrication", $"{lang}/quote-request/bending-and-fabrication-success",
            new { controller = "QuoteRequest", action = "BendingAndFabricationSuccess" });

        //Albina Bending and Fabrication Google
        endpointRouteBuilder.MapControllerRoute("BendingAndFabrication", $"{lang}/quote-request/bending-and-fabrication-google",
            new { controller = "QuoteRequest", action = "BendingAndFabricationGoogle" });

        //Albina Download Spiral Math Report
        endpointRouteBuilder.MapControllerRoute("DownloadSpiralReport", $"{lang}/download-spiral-math",
