...
public partial class OrderModelFactory : IOrderModelFactory
{
    ...
    //albina added
    protected readonly IShopOrderService _shopOrderService;
    protected readonly IRepository<ShopOrderMTR> _shopOrderMtrRepository;
    ...
    public virtual async Task<CustomerOrderListModel> PrepareCustomerOrderListModelAsync()
    {
        ...
        {
            shopOrders = await _shopOrderService.ListShopOrdersForCustomerAsync(customer.JCCustomerID.Value);
    ...
    /// </returns>
    public virtual async Task<OrderDetailsModel> PrepareOrderDetailsModelAsync(Order order, ShopOrder shopOrder = null)
    {
