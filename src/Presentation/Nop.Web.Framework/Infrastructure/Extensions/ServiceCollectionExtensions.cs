...
public static class ServiceCollectionExtensions
{
    /// <summary>
            ...
            WebApplicationBuilder builder)
        {
            ...
            var configurationSection = builder.Configuration.GetSection("Hosting");
            var hostingConfig = new HostingConfig();
            configurationSection.Bind(hostingConfig);
            services.AddSingleton(hostingConfig);

            configurationSection = builder.Configuration.GetSection("Albina");
            var albinaConfig = new AlbinaConfig();
            configurationSection.Bind(albinaConfig);
            services.AddSingleton(albinaConfig);
