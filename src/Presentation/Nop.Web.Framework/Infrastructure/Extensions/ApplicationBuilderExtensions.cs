...
public static class ApplicationBuilderExtensions
{
    ...
    public static async Task StartEngineAsync(this IApplicationBuilder _)
                ...
                handler.Run(async context =>
                {
                    ...
                    try
                    {
                        ...
                        if (DataSettingsManager.IsDatabaseInstalled())
                        {
                            ...
                            var defaultEmailAccount = await EngineContext.Current.Resolve<IEmailAccountService>().GetEmailAccountByIdAsync(defaultEmailAccountId);
        ...
        public static void UseNopStaticFiles(this IApplicationBuilder application)
        {
            ...
            provider = new WebHelper.AlbinaFileExtensionContentTypeProvider();
            application.UseStaticFiles(new StaticFileOptions
            {
